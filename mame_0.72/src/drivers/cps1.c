...
ROM_START( ffightb )
    ...
    ROM_REGION( 0x18000, REGION_CPU2, 0 ) /* 64k for the audio CPU (+banks) */
    ROM_LOAD( "ff_09.bin", 0x00000, 0x08000, CRC(b8367eb5) SHA1(ec3db29fdd6200e9a8f4f8073a7e34aef731354f) )
    ROM_CONTINUE( 0x10000, 0x08000 )

    ROM_REGION( 0x40000, REGION_SOUND1, 0 ) /* Samples */
    ROM_LOAD( "ff_18.bin", 0x00000, 0x20000, CRC(375c66e7) SHA1(36189e23209ce4ae5d9cbabd1574540d0591e7b3) )
    ROM_LOAD( "ff_19.bin", 0x20000, 0x20000, CRC(1ef137f9) SHA1(974b5e72aa28b87ebfa7438efbdfeda769dedf5e) )
ROM_END
...
GAME( 1989, ffightae, ffight,   cps1_12mhz, ffightae, cps1,     ROT0,   "bootleg", "Final Fight 30th Anniversary Edition" )
GAME( 1989, ffightb,  ffight,   cps1,       ffight,   cps1,     ROT0,   "Capcom", "Final Fight Extra" )
...
GAME( 1991, sf2,      0,        cps1,       sf2,      cps1,     ROT0,   "Capcom", "Street Fighter II - The World Warrior (World 910522)" )	// "ETC"
GAME( 1991, sf2eb,    sf2,      cps1,       sf2,      cps1,     ROT0,   "Capcom", "Street Fighter II - The World Warrior (World 910214)" )	// "ETC"
GAME( 1991, sf2ua,    sf2,      cps1,       sf2,      cps1,     ROT0,   "Capcom", "Street Fighter II - The World Warrior (US 910206)" )
GAME( 1991, sf2ub,    sf2,      cps1,       sf2,      cps1,     ROT0,   "Capcom", "Street Fighter II - The World Warrior (US 910214)" )
GAME( 1991, sf2ud,    sf2,      cps1,       sf2,      cps1,     ROT0,   "Capcom", "Street Fighter II - The World Warrior (US 910318)" )
GAME( 1991, sf2ue,    sf2,      cps1,       sf2,      cps1,     ROT0,   "Capcom", "Street Fighter II - The World Warrior (US 910228)" )
GAME( 1991, sf2uf,    sf2,      cps1,       sf2,      cps1,     ROT0,   "Capcom", "Street Fighter II - The World Warrior (US 910411)" )
GAME( 1991, sf2ui,    sf2,      cps1,       sf2,      cps1,     ROT0,   "Capcom", "Street Fighter II - The World Warrior (US 910522)" )
GAME( 1991, sf2uk,    sf2,      cps1,       sf2,      cps1,     ROT0,   "Capcom", "Street Fighter II - The World Warrior (US 911101)" )
GAME( 1991, sf2j,     sf2,      cps1,       sf2j,     cps1,     ROT0,   "Capcom", "Street Fighter II - The World Warrior (Japan 911210)" )
GAME( 1991, sf2ja,    sf2,      cps1,       sf2j,     cps1,     ROT0,   "Capcom", "Street Fighter II - The World Warrior (Japan 910214)" )
GAME( 1991, sf2jc,    sf2,      cps1,       sf2j,     cps1,     ROT0,   "Capcom", "Street Fighter II - The World Warrior (Japan 910306)" )
...
GAME( 1992, sf2ce,    0,        cps1_12mhz, sf2,      cps1,     ROT0,   "Capcom", "Street Fighter II' - Champion Edition (World 920313)" )	// "ETC"
GAME( 1992, sf2ceua,  sf2ce,    cps1_12mhz, sf2,      cps1,     ROT0,   "Capcom", "Street Fighter II' - Champion Edition (US 920313)" )
GAME( 1992, sf2ceub,  sf2ce,    cps1_12mhz, sf2,      cps1,     ROT0,   "Capcom", "Street Fighter II' - Champion Edition (US 920513)" )
GAME( 1992, sf2ceuc,  sf2ce,    cps1_12mhz, sf2,      cps1,     ROT0,   "Capcom", "Street Fighter II' - Champion Edition (US 920803)" )
GAME( 1992, sf2cej,   sf2ce,    cps1_12mhz, sf2j,     cps1,     ROT0,   "Capcom", "Street Fighter II' - Champion Edition (Japan 920513)" )
GAME( 1992, sf2rb,    sf2ce,    cps1_12mhz, sf2,      cps1,     ROT0,   "hack",  "Street Fighter II' - Champion Edition (Rainbow set 1)" )	// 920322 - based on World version
GAME( 1992, sf2rb2,   sf2ce,    cps1_12mhz, sf2,      cps1,     ROT0,   "hack",  "Street Fighter II' - Champion Edition (Rainbow set 2)" )	// 920322 - based on World version
GAME( 1992, sf2red,   sf2ce,    cps1_12mhz, sf2,      cps1,     ROT0,   "hack",  "Street Fighter II' - Champion Edition (Red Wave)" )		// 920313 - based on World version
GAME( 1992, sf2v004,  sf2ce,    cps1_12mhz, sf2,      cps1,     ROT0,   "hack",  "Street Fighter II! - Champion Edition (V004)" )		// "102092" !!! - based on (heavily modified) World version
GAME( 1992, sf2accp2, sf2ce,    cps1_12mhz, sf2,      cps1,     ROT0,   "hack",  "Street Fighter II' - Champion Edition (Accelerator Pt.II)" )  // 920313 - based on USA version
...
GAME( 1992, sf2t,     sf2ce,    cps1_12mhz, sf2,      cps1,     ROT0,   "Capcom", "Street Fighter II' - Hyper Fighting (US 921209)" )
GAME( 1992, sf2tj,    sf2ce,    cps1_12mhz, sf2j,     cps1,     ROT0,   "Capcom", "Street Fighter II' Turbo - Hyper Fighting (Japan 921209)" )
GAME( 1992, qad,      0,        cps1_12mhz, qad,      cps1,     ROT0,   "Capcom", "Quiz & Dragons (US 920701)" )
GAME( 1994, qadj,     qad,      cps1_12mhz, qadj,     cps1,     ROT0,   "Capcom", "Quiz & Dragons (Japan 940921)" )
