...
static int calc3_decompress_table(int tabnum, UINT8* dstram, int dstoffset)
{
	...
	{
		logerror("CALC3 error, requested table > num tables!\n");
		return 0;
	}
...
ROM_START( gtmra )
	...
	ROM_REGION( 0x840000, REGION_GFX1, 0 )	/* Sprites */
	ROM_LOAD( "mm-200-402-s0.bin",  0x000000, 0x200000, CRC(c0ab3efc) SHA1(e6cd15480977b036234d91e6f3a6e21b7f0a3c3e) )
	ROM_LOAD( "mm-201-403-s1.bin",  0x200000, 0x200000, CRC(cf6b23dc) SHA1(ccfd0b17507e091e55c169361cd6a6b19641b717) )
	ROM_LOAD( "mm-202-404-s2.bin",  0x400000, 0x200000, CRC(8f27f5d3) SHA1(219a86446ce2556682009d8aff837480f040a01e) )
	ROM_LOAD( "mm-203-405-s3.bin",  0x600000, 0x080000, CRC(e9747c8c) SHA1(2507102ec34755c6f110eadb3444e6d3a3474051) )
	...
	ROM_REGION( 0x200000, REGION_GFX2, 0 )	/* Tiles (scrambled) */
	ROM_LOAD( "mm-300-406-a0.bin",  0x000000, 0x200000, CRC(b15f6b7f) SHA1(5e84919d788add53fc87f4d85f437df413b1dbc5) )

	ROM_REGION( 0x200000, REGION_GFX3, 0 )	/* Tiles (scrambled) */
	ROM_COPY(REGION_GFX2,0,0,0x200000) // it isn't on the board twice.
...
GAME(  1991, berlwallt,berlwall, berlwall, berlwalt, berlwall,   ROT0,  "Kaneko", "The Berlin Wall (set 2)" )
...
GAME(  1991, mgcrystl, 0,        mgcrystl, mgcrystl, kaneko16,   ROT0,  "Kaneko", "Magical Crystals (World, 92/01/10)" )
GAME(  1991, mgcrystlo,mgcrystl, mgcrystl, mgcrystl, kaneko16,   ROT0,  "Kaneko", "Magical Crystals (World, 91/12/10)" )
GAME(  1991, mgcrystlj,mgcrystl, mgcrystl, mgcrystl, kaneko16,   ROT0,  "Kaneko", "Magical Crystals (Japan, 92/01/13)" )
...
GAME(  1994, bonkadv,  0,        bonkadv , bonkadv,  bloodwar,   ROT0,  "Kaneko", "Bonk's Adventure" )
GAMEX( 1994, bloodwar, 0,        bloodwar, bloodwar, bloodwar,   ROT0,  "Kaneko", "Blood Warrior", GAME_IMPERFECT_GRAPHICS )
GAME(  1994, gtmr,     0,        gtmr,     gtmr,     kaneko16,   ROT0,  "Kaneko", "1000 Miglia : Great 1000 Miles Rally (94/07/18)" )
GAMEX( 1994, gtmra,    gtmr,     gtmr,     gtmr,     kaneko16,   ROT0,  "Kaneko", "1000 Miglia : Great 1000 Miles Rally (94/06/13)", GAME_NOT_WORKING ) // MCU Stall
GAME(  1994, gtmre,    gtmr,     gtmr,     gtmr,     kaneko16,   ROT0,  "Kaneko", "Great 1000 Miles Rally : Evolution Model!!! (94/09/06)" )
GAME(  1994, gtmrusa,  gtmr,     gtmr,     gtmr,     kaneko16,   ROT0,  "Kaneko", "Great 1000 Miles Rally : U.S.A Version! (94/09/06)" ) // U.S.A version seems part of the title, rather than region
...
GAMEX( 1992, shogwarre,shogwarr, shogwarr, shogwarr, shogwarr,   ROT0,  "Kaneko", "Shogun Warriors (Euro)", GAME_IMPERFECT_GRAPHICS )
