...
TESTDRIVER( shisen2 )
	...
	DRIVER( uccopsar )	/* (c) 1992 Irem (Japan) */
...
TESTDRIVER( defndjeu )	/* bootleg */
	...
	DRIVER( ffightae )	/* Bootleg */
	DRIVER( ffightb )	/* Bootleg */
...
TESTDRIVER( jgokushi )	/* 27/05/1999 Jyangokushi: Haoh no Saihai (Japan) */
    ...
    DRIVER( pzloop2j )	/* 05/02/2001 Puzz Loop 2 (Mitchell) */
...
TESTDRIVER( gardiab )	/* bootleg */
	...
	DRIVER( wbmlvc )    /* Sega/Westone Virtual Console English Version */
...
/* end of similar hardware */
	...
	/* Data East MLC Games */
	DRIVER( avengrgs )	/* MCG (c) 1995 Data East Corporation (Euro) */
	DRIVER( avengrgsj ) /* MCG (c) 1995 Data East Corporation (Japan) */
	DRIVER( skullfng )	/* MCH (c) 1996 Data East Corporation (Euro) */
	DRIVER( skullfngj )	/* MCH (c) 1996 Data East Corporation (Japan) */
    DRIVER( hoops96 )   /* MCE (c) 1996 Data East Corporation (Euro) */
...
TESTDRIVER( tstrike )	/* Game Room */
	...
	DRIVER( ddragon3 )	/* TA-0030 (c) 1990 USA */
...
TESTDRIVER( spdbuggy )
	...
	DRIVER( mortalr )	/* (c) 1995 New Dream Games */
