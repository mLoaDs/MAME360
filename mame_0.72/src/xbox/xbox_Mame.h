...
#define DRIVERLIST_FILESTAMP      "MAME " VERSION_STRING
...
void RemapDriveLetters( void );
  ...
  //! \brief    Set up the renderer to output to a texture
	//-------------------------------------------------------------------
BOOL RenderToTextureStart( RenderToTextureToken_t &token, LPDIRECT3DDEVICE9 pD3DDevice, LPDIRECT3DDEVICE9 texture, D3DVIEWPORT9 &textureViewpoint );
