												...
												void *vector_dirty_pixels )
{
  ...
  lpTexture->UnlockRect(0);
	...
	psEffect->SetVideoInputs(nTextureWidth,nTextureHeight,1280,720, frameCount); 
...
static BOOL CreateRenderingQuad( void )
{
  ...
  if( g_pD3DVertexBuffer )
  {
	...
	VidSScaleImage(&Dest,g_textureRenderingArea.right-g_textureRenderingArea.left , g_textureRenderingArea.bottom-g_textureRenderingArea.top);
