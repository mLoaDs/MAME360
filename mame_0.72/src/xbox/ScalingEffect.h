...
class ScalingEffect
{
	...
	D3DXHANDLE	m_VideoInputHandle;
	D3DXHANDLE	m_VideoSizeHandle;
	D3DXHANDLE	m_TextureSizeHandle;
	D3DXHANDLE	m_OutputSizeHandle;

	// fun stuff

	D3DXHANDLE	m_FrameCount;
...
public:
	...
	HRESULT SetVideoInputs(int iWidth, int iHeight, int vpWidth, int vpHeight, int fc);
