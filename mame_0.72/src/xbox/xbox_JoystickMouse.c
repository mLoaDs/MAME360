...
//		PRINTMSG(( T_ERROR, "Invalid joynum %lu!", joynum ));
	...
	switch( joytype )
	{
		case JT_BUTTON:
			...
			{
				case BUTTON_A:
					return ((gamepad->wButtons & XINPUT_GAMEPAD_A) > ANALOG_BUTTON_AS_DIGITAL_DEADZONE);
				case BUTTON_X:
					return ((gamepad->wButtons & XINPUT_GAMEPAD_X) > ANALOG_BUTTON_AS_DIGITAL_DEADZONE);
				case BUTTON_B:
					return ((gamepad->wButtons & XINPUT_GAMEPAD_B) > ANALOG_BUTTON_AS_DIGITAL_DEADZONE);
				case BUTTON_Y:
					return ((gamepad->wButtons & XINPUT_GAMEPAD_Y) > ANALOG_BUTTON_AS_DIGITAL_DEADZONE);
				case BUTTON_LEFT_TRIGGER:
					return ((gamepad->bLeftTrigger) > ANALOG_BUTTON_AS_DIGITAL_DEADZONE);
				case BUTTON_RIGHT_TRIGGER:
					return ((gamepad->bRightTrigger) > ANALOG_BUTTON_AS_DIGITAL_DEADZONE);
				case BUTTON_START:
					return (gamepad->wButtons & XINPUT_GAMEPAD_START);
				case BUTTON_BACK:
					return (gamepad->wButtons & XINPUT_GAMEPAD_BACK);
				case BUTTON_WHITE:					
					return (gamepad->wButtons & XINPUT_GAMEPAD_LEFT_SHOULDER);
				case BUTTON_BLACK:
					return (gamepad->wButtons & XINPUT_GAMEPAD_RIGHT_SHOULDER);
				case BUTTON_LA:
    ...
    case JT_BUTTON:
      {
        ...
        {
        case BUTTON_A:
          analog_axis[i] = (int)(gamepad->wButtons & XINPUT_GAMEPAD_A) - 128;
          break;

        case BUTTON_X:
          analog_axis[i] = (int)(gamepad->wButtons & XINPUT_GAMEPAD_X) - 128;
          break;

        case BUTTON_B:
          analog_axis[i] = (int)(gamepad->wButtons & XINPUT_GAMEPAD_B) - 128;
          break;

        case BUTTON_Y:
          analog_axis[i] = (int)(gamepad->wButtons & XINPUT_GAMEPAD_Y) - 128;
          break;

        case BUTTON_LEFT_TRIGGER:
          analog_axis[i] = (int)gamepad->bLeftTrigger - 128;
          break;

        case BUTTON_RIGHT_TRIGGER:
          analog_axis[i] = (int)gamepad->bRightTrigger - 128;
          break;

        case BUTTON_WHITE:
          analog_axis[i] = (int)(gamepad->wButtons & XINPUT_GAMEPAD_LEFT_SHOULDER);
          break;

        case BUTTON_BLACK:
          analog_axis[i] = (int)(gamepad->wButtons & XINPUT_GAMEPAD_RIGHT_SHOULDER);;
          break;
...
void InitializeJoystickMouse( void )
{
  ...
  INT32 stickIndex = 0;
    ...
    ADDENTRY( "LShoul",        JOYCODE( stickIndex, JT_BUTTON, BUTTON_WHITE ),          CODE_OTHER );
    ADDENTRY( "RShoul",        JOYCODE( stickIndex, JT_BUTTON, BUTTON_BLACK ),          CODE_OTHER );
    ADDENTRY( "LThumb",           JOYCODE( stickIndex, JT_BUTTON, BUTTON_LA ),             CODE_OTHER );
    ADDENTRY( "RThumb",           JOYCODE( stickIndex, JT_BUTTON, BUTTON_RA ),             CODE_OTHER );
  }
}
